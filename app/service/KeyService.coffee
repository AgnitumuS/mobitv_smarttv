...
#  @android = _.extend @desktop, {}
  ...
  key: ()->
    key = _.extend @common, @[fimplus.config.platform]
    return key
  
  registeKeyTizen: ()->
    return if fimplus.config.platform isnt 'tv_tizen'
...
#        UtitService.back()
  ...
  initKey: (handleKey, classActiveKey, active = true)->
    ...
    if active
      ...
      fimplus.UtitService.disconnectionCallback = self.initKey.bind(self, handleKey, classActiveKey)
    onKeyDown = (e)->
      keyCode = e.keyCode
